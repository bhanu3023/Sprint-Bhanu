...
\restrict ONBRSWGzfBGui1oa8FlbU6fS2JwqxAMu8Tg2Qmj1INKXAYN5gFMIXQd5y6cljzi
...
--
-- Name: issue_attachments; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: issue_field_values; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: issue_links; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: roadmap_colors; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: session_expiry_reminders; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: space_favorites; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: issue_attachments issue_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: issue_field_values issue_field_values_issue_id_field_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issue_field_values
    ADD CONSTRAINT issue_field_values_issue_id_field_id_key UNIQUE (issue_id, field_id);


--
-- Name: issue_field_values issue_field_values_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issue_field_values
    ADD CONSTRAINT issue_field_values_pkey PRIMARY KEY (id);
...
--
-- Name: issue_links issue_links_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: issue_links issue_links_source_id_target_id_link_type_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issue_links
    ADD CONSTRAINT issue_links_source_id_target_id_link_type_key UNIQUE (source_id, target_id, link_type);
...
--
-- Name: roadmap_colors roadmap_colors_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.roadmap_colors
    ADD CONSTRAINT roadmap_colors_pkey PRIMARY KEY (color_key, created_by);
...
--
-- Name: session_expiry_reminders session_expiry_reminders_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.session_expiry_reminders
    ADD CONSTRAINT session_expiry_reminders_pkey PRIMARY KEY (id);


--
-- Name: session_expiry_reminders session_expiry_reminders_user_id_session_token_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.session_expiry_reminders
    ADD CONSTRAINT session_expiry_reminders_user_id_session_token_key UNIQUE (user_id, session_token);
...
--
-- Name: space_favorites space_favorites_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.space_favorites
    ADD CONSTRAINT space_favorites_pkey PRIMARY KEY (user_id, space_id);
...
--
-- Name: idx_comments_issue_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_issues_deleted_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_issues_space_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_issues_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_worklogs_issue_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: audit_logs audit_logs_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.audit_logs
    ADD CONSTRAINT audit_logs_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id);
...
--
-- Name: custom_fields custom_fields_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.custom_fields
    ADD CONSTRAINT custom_fields_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id);
...
--
-- Name: issue_attachments issue_attachments_issue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: issue_attachments issue_attachments_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issue_attachments
    ADD CONSTRAINT issue_attachments_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: issue_field_values issue_field_values_field_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issue_field_values
    ADD CONSTRAINT issue_field_values_field_id_fkey FOREIGN KEY (field_id) REFERENCES public.custom_fields(id);


--
-- Name: issue_field_values issue_field_values_issue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issue_field_values
    ADD CONSTRAINT issue_field_values_issue_id_fkey FOREIGN KEY (issue_id) REFERENCES public.issues(id);
...
ALTER TABLE ONLY public.issue_history
    ADD CONSTRAINT issue_history_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: issue_links issue_links_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issue_links
    ADD CONSTRAINT issue_links_source_id_fkey FOREIGN KEY (source_id) REFERENCES public.issues(id);


--
-- Name: issue_links issue_links_target_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issue_links
    ADD CONSTRAINT issue_links_target_id_fkey FOREIGN KEY (target_id) REFERENCES public.issues(id);
...
--
-- Name: issues issues_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issues
    ADD CONSTRAINT issues_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.issues(id);
...
--
-- Name: issues issues_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.issues
    ADD CONSTRAINT issues_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id);


--
-- Name: issues issues_sprint_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: roadmap_colors roadmap_colors_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.roadmap_colors
    ADD CONSTRAINT roadmap_colors_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: roadmap_items roadmap_items_assigned_to_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.roadmap_items
    ADD CONSTRAINT roadmap_items_assigned_to_fkey FOREIGN KEY (assigned_to) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: roadmap_items roadmap_items_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.roadmap_items
    ADD CONSTRAINT roadmap_items_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: roadmap_items roadmap_items_issue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.roadmap_items
    ADD CONSTRAINT roadmap_items_issue_id_fkey FOREIGN KEY (issue_id) REFERENCES public.issues(id) ON DELETE SET NULL;


--
-- Name: roadmap_items roadmap_items_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.roadmap_items
    ADD CONSTRAINT roadmap_items_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id) ON DELETE SET NULL;


--
-- Name: saved_filters saved_filters_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.saved_filters
    ADD CONSTRAINT saved_filters_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id);
...
ALTER TABLE ONLY public.saved_filters
    ADD CONSTRAINT saved_filters_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: space_favorites space_favorites_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.space_favorites
    ADD CONSTRAINT space_favorites_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id);


--
-- Name: space_favorites space_favorites_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.space_favorites
    ADD CONSTRAINT space_favorites_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.spaces
    ADD CONSTRAINT spaces_org_id_fkey FOREIGN KEY (org_id) REFERENCES public.organizations(id);


--
-- Name: spaces spaces_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sprints sprints_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sprints
    ADD CONSTRAINT sprints_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id);
...
\unrestrict ONBRSWGzfBGui1oa8FlbU6fS2JwqxAMu8Tg2Qmj1INKXAYN5gFMIXQd5y6cljzi
