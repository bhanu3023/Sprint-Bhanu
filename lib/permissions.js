...
const UPDATE_WHITELIST = {
  spaces: ['name', 'key', 'description', 'icon', 'color', 'space_type', 'visibility', 'owner_id', 'is_archived', 'issue_counter', 'spillover_developers_only'],
  spaces_space_admin: ['name', 'description', 'icon', 'color', 'spillover_developers_only'],
