/**
 * Default custom fields for every space.
 * Seeded on new space creation and backfilled for existing spaces (by name).
 * Built-in issue columns (title, status, assignee, sprint, etc.) stay on the form;
 * these appear under Custom Fields and in Settings → Custom Fields for editing.
 */
